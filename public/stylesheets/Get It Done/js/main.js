...
input.addEventListener("keydown", function(e) {
  if(e.keyCode === 13) {
    ...
    addTasks(taskStore, task, function() {
...
function updateTasks() {
  // deleteAllTasks(taskStore,function(){
...
function deleteTaskOnClick(elem) {
  ...
  let task = readOneTask(taskStore, id, function(task) {
      ...
      addTasks(completedTaskStore, completedTask, function() {
...
function updateTheme(theme){
  ...
  let text = theme=='light' ? "12, 12, 12":"255,255,255";
  // let shadowColor = theme=='light' ? "0, 0, 0":"255,255,255";
  let grad1 = theme=='light' ? "255, 255, 0":"38,208,163";
  let grad2 = theme=='light' ? "108, 25, 148":"32,173,211";
